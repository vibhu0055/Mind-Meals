...
export default function HealthPage() {
  ...
  const validate = () => {
    ...
    if (!form.student_id)
      e.student_id = 'Required';

    if (!form.height_cm)
      e.height_cm = 'Required';

    if (!form.weight_kg)
      e.weight_kg = 'Required';
  ...
  const handleAdd = async (ev) => {
    ...
    try {
      await addHealthRecord({
        ...
        muac_cm: form.muac_cm
          ? parseFloat(form.muac_cm)
          : undefined,
      });
  ...
  const studentName = students.find(
    (s) =>
      String(s.id) === String(selectedStudent)
  )?.name;
    ...
    <div className="animate-fade-in">
      ...
      {!selectedStudent ? (
        <EmptyState
          ...
          description="Choose a student above to view their health records"
        />
      ) : loading ? (
        <PageLoader />
      ) : records.length === 0 ? (
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={label}>
                      ...
                      <div className="text-sm font-semibold text-[var(--text-primary)] mt-0.5 mono">
                        {value}
                      </div>
                    </div>
                  ))}
